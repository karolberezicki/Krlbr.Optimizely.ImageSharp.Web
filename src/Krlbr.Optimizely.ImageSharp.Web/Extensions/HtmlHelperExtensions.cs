...
public static class HtmlHelperExtensions
{
    ...
    public static UrlBuilder ProcessImageWithFallback(this IHtmlHelper _, ContentReference? image, string imageFallback)
    {
        return ConstructUrl(image is null || image == ContentReference.EmptyReference ? imageFallback : UrlResolver.Current.GetUrl(image));
    }
