...
The `Krlbr.Optimizely.ImageSharp.Web` repo uses Git as its source control system. If you haven't already installed it, you can download it [here](https://git-scm.com/downloads) or if you prefer a GUI-based approach, try [GitHub Desktop](https://desktop.github.com/).
...
```shell
git clone https://github.com/karolberezicki/Krlbr.Optimizely.ImageSharp.Web.git
```
Cloning via SSH:

```shell
git clone git@github.com:karolberezicki/Krlbr.Optimizely.ImageSharp.Web.git
```
